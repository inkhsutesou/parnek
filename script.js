/**
 * TODO:
 * - Floating Index/Header populated from H1
 * - Chore Rotation
 * - People / Organizations Code 2h
 * - [ ] Choose Images For NPCs
 * - [ ] Link People, Organizations, Places
 * - [ ] Create World Map FantasyMaps 30m
 * - [ ] Revealable Maps
 * - [ ] Placeable Citadels/Dungeons 2h
 */
...
const parnekVersion = document.querySelector( 'script[data-date]' )
...
const lessSetup = () => {
  ...
  lessStyleNode.setAttribute( 'href', `./src/css/styles.less?${ Math.random() }` )
